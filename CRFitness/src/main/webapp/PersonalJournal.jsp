 	                         ...
 	                         $.ajax({
 	                             ...
 	                             success:function(data){
 	                                 ...
 	                                 $.each(data,function(){
 	            						...
 	            						var jdate_value = new Date(jdate_int);
 	            						var jdate_int2 = parseInt(this[2].deadline);                          //轉換成數字
 										...
 										+this[2].activity_Id+'.jpg" class="lightbox_image boxer" data-lightbox-gallery="image_gallery" rel="gallery" title="發起人：'
 										+this[2].activity_Id+"<i class='fa fa-commenting-o img-responsive' aria-hidden='true'></i>"
 										+'<br />類別：'+this[2].activity_Class+'<br />地區：'
 										+this[2].activity_Area+'<br />內容：'
 										+this[2].activity_Info+'<br />活動時間：'
 										...
 										+"<div hidden='hidden'>"+this[2].activity_Id
 										+'</div>"><span title=""><img src="${this_contextPath}/images/activitys/'
 										+this[2].activity_Id+'.jpg" class="jouranl_activity" alt="Independence Day" /></span></a>'
