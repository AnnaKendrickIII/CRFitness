...
<!-- 		<div class="col-md-1"></div> -->
		...
		<button type="button" id="creProdBtn" class="btn btn-primary btn-success btn-1g" data-toggle="modal" data-target="#new_products">  
...
// 					console.log(this[0].product_Status);
					...
					$('#products_tbody').append('<tr class="'+this[0].productDetail_Id+'"><td><img src="${this_contextPath}/CRFSERVICE/productDetailControllerBE/photo/'
													...
													+ '</td><td><button type="button" class="btn btn-primary btn-1g 2g" data-toggle="modal" data-target="#update_products"><i class="fa fa-refresh" aria-hidden="true"></i>'
													+ '</td><td><button type="button" class="btn btn-primary btn-danger btn-1g 3g" data-toggle="modal" data-target="#change_status"><span class="easyswitch" data-default="'+Status+'" data-label-on="上架" data-label-off="下架"></i>'
													+ '</td></tr>') // end of append
												}) // end of $.each(
					// 產品狀態switch的程式   開始
